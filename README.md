...
This project is to give the X1C6 a complete and functional build of macOS Sonoma 15 using the guide from [here](https://github.com/tylernguyen/x1c6-hackintosh) with modified ACPI and updated kexts.
